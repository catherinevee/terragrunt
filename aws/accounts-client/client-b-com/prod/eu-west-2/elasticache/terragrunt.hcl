# ==============================================================================
# ElastiCache Module Configuration for Client B - Production Environment (eu-west-2)
# ==============================================================================
include "root" {
...
inputs = {
  ...
  elasticache_config = {
    ...
    cluster_config = {
      cluster_id = "client-b-prod-redis"
      engine = "redis"
      engine_version = "7.0"
      ...
      kms_key_id = dependency.kms.outputs.key_arns["prod-elasticache-key"]
      ...
      replication_group_id = "client-b-prod-redis-repl"
      num_cache_clusters = 2
      
      # Parameter group
      parameter_group_name = "client-b-prod-redis-7-0"
    ...
    subnet_group_config = {
      name = "client-b-prod-redis-subnet-group"
      description = "Subnet group for Client B production Redis cluster"
