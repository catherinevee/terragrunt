# ==============================================================================
# Application Load Balancer Module Configuration for Client B - Staging Environment (eu-west-2)
# ==============================================================================
include "root" {
...
inputs = {
  ...
  alb_config = {
    ...
    lb_config = {
      ...
      # Access logs
      access_logs = {
        bucket = "client-b-staging-alb-logs"
        prefix = "alb-logs"
        enabled = true
      }
