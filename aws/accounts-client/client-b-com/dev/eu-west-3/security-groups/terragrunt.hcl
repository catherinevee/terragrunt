# ==============================================================================
# Security Groups Module Configuration for Client B - Development Environment (eu-west-3)
# ==============================================================================
...
inputs = {
  ...
  security_groups_config = {
    ...
    default = {
      name = "client-b-dev-default-sg"
      description = "Default security group for Client B development environment"
      vpc_id = dependency.vpc.outputs.vpc_id
      tags = {
        Name = "client-b-dev-default-sg"
    ...
    web = {
      name = "client-b-dev-web-sg"
      description = "Security group for web tier in Client B development environment"
      vpc_id = dependency.vpc.outputs.vpc_id
      tags = {
        Name = "client-b-dev-web-sg"
      ...
      rules = {
        ...
        ssh_inbound = {
          ...
          to_port = 22
          protocol = "tcp"
          cidr_blocks = ["10.3.0.0/16"]  # VPC CIDR
    ...
    app = {
      name = "client-b-dev-app-sg"
      description = "Security group for application tier in Client B development environment"
      vpc_id = dependency.vpc.outputs.vpc_id
      tags = {
        Name = "client-b-dev-app-sg"
    ...
    database = {
      name = "client-b-dev-database-sg"
      description = "Security group for database tier in Client B development environment"
      vpc_id = dependency.vpc.outputs.vpc_id
      tags = {
        Name = "client-b-dev-database-sg"
    ...
    elasticache = {
      name = "client-b-dev-elasticache-sg"
      description = "Security group for ElastiCache in Client B development environment"
      vpc_id = dependency.vpc.outputs.vpc_id
      tags = {
        Name = "client-b-dev-elasticache-sg"
    ...
    alb = {
      name = "client-b-dev-alb-sg"
      description = "Security group for Application Load Balancer in Client B development environment"
      vpc_id = dependency.vpc.outputs.vpc_id
      tags = {
        Name = "client-b-dev-alb-sg"
