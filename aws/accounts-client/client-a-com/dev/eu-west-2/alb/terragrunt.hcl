# ==============================================================================
# Application Load Balancer Module Configuration for Client A - Development Environment (eu-west-2)
# ==============================================================================
...
inputs = {
  ...
  alb_config = {
    ...
    load_balancer = {
      ...
      # Access logs
      access_logs = {
        bucket = "client-a-dev-logs-${include.common.locals.account_id}"
        prefix = "alb-logs"
        enabled = true
      }
    ...
    listeners = {
      ...
      https = {
        ...
        certificate_arn = "arn:aws:acm:${include.region.locals.region_name}:${include.common.locals.account_id}:certificate/dev-cert-id"  # Placeholder
        default_action = {
          type = "forward"
          target_group_arn = "self"  # Will reference web target group
        }
